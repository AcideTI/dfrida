...
CREATE TABLE `almacen_prod`  (
  ...
  CONSTRAINT `almacen_prod_ibfk_1` FOREIGN KEY (`idProd`) REFERENCES `producto` (`idProd`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ficha_proceso`  (
  ...
  `nombreFichaProc` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 154 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ingreso_prod`  (
  ...
  INDEX `idProd`(`idProd`) USING BTREE,
  CONSTRAINT `ingreso_prod_ibfk_1` FOREIGN KEY (`idProd`) REFERENCES `producto` (`idProd`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = DYNAMIC;
...
-- Records of usuario
-- ----------------------------
INSERT INTO `usuario` VALUES (1, 1, 'dfrida', 'Administrador', 'administrador', '$argon2id$v=19$m=4096,t=2,p=2$ZURZWG0yNkNOZVJTLlg5Lw$MvzbwXUNlV+Inxssd1nN+A8EN5Il6CdSAs7pTc3szJk', '2024-07-09 09:07:22', '2024-02-16 12:09:23', '2024-02-16 12:09:23');
